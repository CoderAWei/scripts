 ...
 */
const $ = new Env('点点券');
const ZooFaker=require('./raw_ZooFaker_Necklace.js').utils;
let allMessage = ``;
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      message = '';
      errorMsgLllegal = 0
      UA = `jdapp;android;10.0.10;11;${randomString(28)}-5343631343032623;network/wifi;model/M2011K2C;addressid/138087843;aid/0a4fc8ec9548a7f9;oaid/3ac46dd4d42fa41c;osVer/28;appBuild/88569;partner/jingdong;eufv/1;jdSupportDarkMode/0;Mozilla/5.0 (Linux; Android 9; M2011K2C Build/PKQ1.180729.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045715 Mobile Safari/537.36`
