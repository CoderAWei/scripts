...
[task_local]
#京享值PK
15 2,16 * 6 * https://raw.githubusercontent.com/Xzw111222/main/xzw_jxz_pk.js, tag=京享值PK
================Loon==============
[Script]
cron "15 2,16 * 6 *" script-path=https://raw.githubusercontent.com/Xzw111222/main/xzw_jxz_pk.js,tag=京享值PK
===============Surge=================
京享值PK = type=cron,cronexp="15 2,16 * 6 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Xzw111222/main/xzw_jxz_pk.js
============小火箭=========
京享值PK = type=cron,script-path=https://raw.githubusercontent.com/Xzw111222/main/xzw_jxz_pk.js, cronexpr="15 2,16 * 6 *", timeout=3600, enable=true
 */
const $ = new Env('京享值PK');
$.toObj = (t, e = null) => {
	try {
